        ...
        <main className="py-20 lg:py-32">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              The minimalist approach to building great products. Focus on what matters most with
              our clean, distraction-free platform.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                type="button"
                className="border-2 border-black dark:border-white text-black dark:text-white px-8 py-4 rounded-md font-semibold hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors"
                onClick={onViewDemo}
              >
                View Demo
              </button>
